...
CMAPS = {
    "NWSRef": plt.cm.get_cmap("plasma"),
    "HomeyerRainbow": plt.cm.get_cmap("rainbow"),
    "NWSStormClearReflectivity": plt.cm.get_cmap("viridis"),
    "BlueBrown12": plt.cm.get_cmap("Blues"),
    "Carbone42": plt.cm.get_cmap("jet"),
    "NWSVelocity": plt.cm.get_cmap("RdBu_r"),
    "BuDRd18": plt.cm.get_cmap("PiYG"),
    "BlueBrown18": plt.cm.get_cmap("bwr"),
